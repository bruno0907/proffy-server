...
routes.patch('/proffy/profile/update-avatar', multer(multerConfig).single('file'), avatarController.update)
// routes.patch('/proffy/profile/update-avatar', avatarController.update)
